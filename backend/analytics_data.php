...
// Gets assigned roles data
$assigned_roles_query = $pdo->query("
    SELECT 
        u.user_id,
        u.name AS user_name,
        u.personality,
    ...
    ORDER BY u.name ASC
");
$assigned_roles = $assigned_roles_query->fetchAll(PDO::FETCH_ASSOC);
...
$feature_list = ['register_user', 'match_users', 'add_post', 'add_project_role', 'create_admin', 'assign_role'];
$feature_usage_data = [];
